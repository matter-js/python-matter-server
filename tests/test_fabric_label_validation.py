...
class TestFabricLabelValidation:
    ...
    @pytest.mark.asyncio
    async def test_fabric_label_over_32_chars_truncated(self, mock_device_controller, caplog):
        """Test that fabric labels over 32 characters are truncated."""
        long_label = "This is a very long fabric label that exceeds the 32 character limit"
    ...
    @pytest.mark.asyncio
    async def test_fabric_label_unicode_characters(self, mock_device_controller, caplog):
